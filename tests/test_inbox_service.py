...
class TestInboxServiceProcess:
    ...
    @patch("backend.domain.inbox_service.SUPPORT_ADDRESSES", ["support@republic.ru"])
    ...
    @patch("backend.domain.inbox_service.CHIEF_EDITOR_EMAIL", "editor@test.com")
    @patch("backend.domain.inbox_service.EMAIL_ADDRESS", "inbox@republic.ru")
    @patch("backend.domain.inbox_service.SUPPORT_ADDRESSES", [])
...
class TestHandleEditorial:
    ...
    @patch("backend.domain.inbox_service.CHIEF_EDITOR_EMAIL", "")
