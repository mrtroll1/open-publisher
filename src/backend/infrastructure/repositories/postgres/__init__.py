...
from backend.infrastructure.repositories.postgres.goal_repo import GoalRepo
...
class DbGateway(KnowledgeRepo, EnvironmentRepo, UserRepo, MessageRepo, RunLogRepo, PermissionRepo, GoalRepo):
    pass
