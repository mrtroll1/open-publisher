...
_DM_ROLE_CONTEXT = {
    "admin": (
        "Это приватный чат с администратором Republic. Полный доступ ко всем функциям. "
        "Можно обсуждать внутренние вопросы, контрагентов, бюджет. Давай развёрнутые ответы."
    ),
    "editor": (
        "Это личный чат с редактором Republic. Помогай с управлением документами для выплат, "
        "контрагентами, редиректами, ставками. Отвечай по-русски, кратко."
    ),
    "user": (
        "Это личный чат с внешним пользователем (не сотрудник Republic). "
        "Ты НЕ знаешь, кто этот человек, если нет данных в разделе «О собеседнике». "
        "Не путай собеседника с собой или с командой Republic. "
        "Будь вежлив. Отвечай по-русски, кратко."
    ),
}
